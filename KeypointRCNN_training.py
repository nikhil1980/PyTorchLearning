...
def main():
    ...
    #  4. Visualize
    KEYPOINTS_FOLDER_TRAIN = 'glue_tubes_keypoints_dataset_134imgs/train_old'
    ...
    model = get_model(num_keypoints=2,
                      weights_path='/Users/nikhil1.bhargava/PycharmProjects/pyTorch-POC/keypointsrcnn_weights.pth')
    model.to(device)
    ...
    # Save paligemma-weights weights after training
